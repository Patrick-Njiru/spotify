...
const Header = () => {
	return (
      ...
      <div className="flex items-center space-x-10">
        ...
        <NavLink id="btn-header" to='/login' className='bg-white text-black rounded-full p-2 pt-3 px-8 font-semibold hover:bg-slate-50 hover:font-extrabold hover:shadow-lg'>Log in</NavLink>
      </div>
		</header>
	)
}
